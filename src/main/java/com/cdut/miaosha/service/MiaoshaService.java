...
public class MiaoshaService {
    ...
    public String creatPath(MiaoshaUser user, long goodsId) {
    ...
    public boolean checkVerifyCode(MiaoshaUser user, long goodsId, int verifyCode) {
        ...
        Integer verifyCodeResult = redisService.get(MiaoshaKey.getMiaoshaVerifyCode, user.getId() + "," + goodsId, Integer.class);
        if(verifyCodeResult == null || verifyCodeResult-verifyCode!=0){
            return false;
        }
